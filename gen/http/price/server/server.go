...
// New instantiates HTTP handlers for all the price service endpoints using the
...
func (s *Server) Service() string { return "price" }
...
func (s *Server) MethodNames() []string { return price.MethodNames[:] }
...
// MountGetHandler configures the mux to serve the "price" service "get"
// endpoint.
