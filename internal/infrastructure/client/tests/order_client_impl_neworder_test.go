...
func TestOrderClientImpl_NewOrder_Cases(t *testing.T) {
	...
	// t.Run("正常系: 現物買い注文 (成行、特定口座) が成功すること", func(t *testing.T) {
	...
	// t.Run("正常系: 現物買い注文 (指値、特定口座) が成功すること", func(t *testing.T) {
	// 	orderReq := request.ReqNewOrder{
	// 		ZyoutoekiKazeiC:          "1",                    // 特定口座
	// 		IssueCode:                "6658",                 // 例: シスメックス
	// 		SizyouC:                  "00",                   // 東証
	...
	// t.Run("正常系: 現物売り注文 (指値、特定口座) が成功すること", func(t *testing.T) {
	// 	orderReq := request.ReqNewOrder{
	// 		ZyoutoekiKazeiC:     "1",    // 特定口座
	// 		IssueCode:           "6658", // 例: シスメックス
	// 		SizyouC:             "00",   // 東証
	...
	// t.Run("正常系: 信用新規買い注文 (成行、特定口座) が成功すること", func(t *testing.T) {
	// 	orderReq := request.ReqNewOrder{
	// 		ZyoutoekiKazeiC:          "1",                    // 特定口座
	...
	// t.Run("正常系: 信用新規売り注文 (成行、特定口座) が成功すること", func(t *testing.T) {
	// 	orderReq := request.ReqNewOrder{
	// 		ZyoutoekiKazeiC:     "1",    // 特定口座
	...
	// 		Condition:                "0",                    // 指定なし
	// 		OrderPrice:               "0",                    // 指値
	// 		OrderSuryou:              "300",                  // 200株 (数量は減らす必要あり)
	// 		GenkinShinyouKubun:       "4",                    // 信用返済 (制度信用6ヶ月)
	// 		OrderExpireDay:           "0",                    // 当日限り
	// 		GyakusasiOrderType:       "0",                    // 通常注文
	// 		GyakusasiZyouken:         "0",                    // 指定なし
	// 		GyakusasiPrice:           "*",                    // 指定なし
	// 		TatebiType:               "2",                    // 個別指定 ここは注意が必要
	// 		TategyokuZyoutoekiKazeiC: "*",                    // 指定なし
	// 		SecondPassword:           c.GetPasswordForTest(), // 第二パスワード (発注パスワード)
	// 		CLMKabuHensaiData: []request.ReqHensaiData{ // 返済リスト
	// 			{
	// 				TategyokuNumber: "202503240000015", // ダミーの建玉番号
	// 				TatebiZyuni:     "",
	// 				OrderSuryou:     "300",
	// 			},
	// 		},
	...
	// t.Run("正常系: 現物買い注文 (逆指値以上で指値) が成功すること", func(t *testing.T) {
	// 	orderReq := request.ReqNewOrder{
	// 		ZyoutoekiKazeiC:          "1",                    // 特定口座
	// 		IssueCode:                "3632",                 // 例: グリー
	// 		SizyouC:                  "00",                   // 東証
	...
	t.Run("正常系: 現物買い注文 (通常+逆指値) が成功すること", func(t *testing.T) {
		orderReq := request.ReqNewOrder{
			ZyoutoekiKazeiC:          "1",                    // 特定口座
