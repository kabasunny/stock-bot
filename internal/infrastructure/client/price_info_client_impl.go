...
func (p *priceInfoClientImpl) GetPriceInfo(ctx context.Context, req request.ReqGetPriceInfo) (*response.ResGetPriceInfo, error) {
	...
	// A real implementation would make a GET request.
	return nil, nil
}

func (p *priceInfoClientImpl) GetPriceInfoWithPost(ctx context.Context, req request.ReqGetPriceInfo) (*response.ResGetPriceInfo, error) {
